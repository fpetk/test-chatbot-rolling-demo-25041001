...
3) Access the `workbench` named `test-chatbot-rolling-demo-25041001-notebook`.
...
5) In the terminal, run `cd test-chatbot-rolling-demo-25041001` to navigate to your sample app's directory.
